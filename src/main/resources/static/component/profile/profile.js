class Profile extends HTMLElement{
    ...
    connectedCallback(){
        ...
        if(user.about != null && user.about != "")
            ...
            about.textContent = "No Information...";
        ...
        num.className = "num";
        num.textContent = user.questionCount + " questions";
        ...
        num1.className = "num";
        num1.textContent = user.commentCount + " answers";
        ...
        title2.textContent = "Bookmarks";
        tag.appendChild(title2);
        const num2 = document.createElement("div");
        num2.className = "num";
        num2.textContent = user.bookmarkCount + " questions";
